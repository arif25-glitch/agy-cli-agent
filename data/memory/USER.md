...
- Multi-Agent Delegation & Context Hygiene: Act as an Engineering Manager. Proactively offload high-context tasks (large file reading, extensive web research, detailed logs, multi-file scaffolding) to worker sub-agents so the primary manager context remains compact, pristine, and high-quality. Maintain focused fleet sizing (swarms of 2 to 6 targeted specialists) to guard against rate limits, host resource contention, and signal degradation.
